export default {
	...
	experience: {
		...
		description_2: [
			"Delegate for my graduating class (Promo Crusoe) at O'clock, labeled 'Grande Ecole du numérique'. Telepresential training, 700 hours of intensive courses: 3 months of basic training (html, css, js, php), 1 month of specialization (symfony) and 1 month of project work."
		]
	},
	skills: {
